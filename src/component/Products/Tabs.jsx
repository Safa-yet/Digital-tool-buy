...
const Tabs = ({setSelectBtn,selecBtn}) => {
...
<div className="tabs tabs-box  bg-gray-200 p-1.5 rounded-full text-white">
  ...
  <input onClick={()=> setSelectBtn("carts")}   type="radio" name="my_tabs_1" className={`tab w-32  rounded-full  ${selecBtn=="carts" &&" linear text-white shadow-black shadow-lg duration-300"} `} aria-label="Cart()"  />
</div>
        </div>
    );
};
